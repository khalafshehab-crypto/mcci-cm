...
const EMPLOYEES = [
  "هشام عريف", "عمار العمودي", "عبدالعزيز ناجي", "موفق سندي", "باسم شهاب الدين", "يعقوب الريمي", "علاء الأهدل", "عماد جمال"
];
...
const EVENT_KINDS = ["اجتماع", "لقاء", "زيارة", "استضافة", "ورشة عمل", "ندوة", "حفل", "تدشين", "إطلاق مبادرة", "توقيع اتفاقية"];
