    ...
    <div className="space-y-6 pb-16 text-right" dir="rtl">
      ...
      {filteredEvents.length === 0 ? (
        ...
        <div className="space-y-6 text-right">
          ...
          <div className="bg-[#e8e4e4] border border-gray-200 rounded-xl sm:rounded-2xl p-4 shadow-sm flex flex-wrap items-center justify-between gap-2.5 sm:gap-3 md:gap-4 font-sans">
...
<div key="filter-popover-1784704070975-1">
...
<div key="filter-popover-1784704070975-2">
                  <span className="text-gray-400 font-bold font-mono">/</span>
          ...
          {selectedCommIdForCards === null ? (
            ...
            <div className="space-y-6 text-right font-sans" dir="rtl">
              <div className="bg-[#e8e4e4] p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl sm:rounded-3xl border border-gray-200 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-2.5 sm:gap-3 md:gap-4">
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-3 md:gap-4 sm:p-6">
                {committees.map((comm) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-[#e8e4e4] hover:bg-[#e2dede] border border-gray-200 hover:border-brand/40 hover:shadow-md transition-all duration-300 rounded-xl sm:rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-6 relative flex flex-col justify-between space-y-6 cursor-pointer group"
                    >
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <span className="p-2.5 rounded-xl sm:rounded-2xl bg-brand/10 text-brand group-hover:scale-110 transition-transform duration-200">
            ...
            <div className="space-y-6 text-right" dir="rtl">
              <div className="bg-[#e8e4e4] p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl sm:rounded-3xl border border-gray-200 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-2.5 sm:gap-3 md:gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl sm:rounded-2xl bg-brand/10 border border-brand/20 flex items-center justify-center text-brand">
              ...
              {(() => {
                ...
                if (commEvents.length === 0 && standaloneRecs.length === 0) {
                  return (
                    <div className="bg-[#e8e4e4] border-2 border-dashed border-gray-300 rounded-xl sm:rounded-2xl sm:rounded-3xl p-12 text-center text-gray-500 font-bold text-sm">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-white/70 border border-gray-300 flex items-center justify-center mx-auto mb-4 text-slate-400">
      ...
      {newRecLinkPromptState.isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm" dir="rtl">
          <div className="bg-white p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl shadow-xl w-[400px] max-w-[90vw] font-sans border border-gray-100">
...
<div key="filter-popover-1784704070975-3">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-3 md:gap-4 sm:p-6">
                    {commEvents.map((evt) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="bg-[#e8e4e4] hover:bg-[#e2dede] border border-gray-200 hover:border-brand/40 hover:shadow-md transition-all duration-300 rounded-xl sm:rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-6 relative flex flex-col justify-between space-y-5"
                        >
                          <div className="space-y-4">
                            ...
                            <div className="space-y-2 text-xs font-bold text-gray-700 bg-white/75 p-4 rounded-xl sm:rounded-2xl border border-gray-300/60 shadow-sm">
                  ...
                  {standaloneRecs.length > 0 && (
                    <div className="mt-10">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 sm:gap-3 md:gap-4 sm:p-6">
                        {standaloneRecs.map((rec: any, idx: number) => {
                          ...
                          return (
                            <motion.div
                              ...
                              initial={{ opacity: 0, scale: 0.98 }}
                              animate={{ opacity: 1, scale: 1 }}
                              className={`bg-[#e8e4e4] hover:bg-[#e2dede] border border-gray-200 hover:border-brand/40 shadow-sm hover:shadow-md transition-all duration-300 rounded-xl sm:rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-6 flex flex-col justify-between space-y-6 text-right relative`}
                            >
                              <div className="space-y-4">
                                <div className="flex items-start justify-between gap-2">
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 sm:gap-3 md:gap-4 bg-[#e8e4e4] p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl sm:rounded-3xl border border-gray-200 shadow-sm">
                      ...
                      <div className="flex items-center gap-2.5 shrink-0">
                        <button
                          ...
                          className="px-3 sm:px-4 py-2 sm:py-2.5 bg-white hover:bg-gray-50 text-slate-700 font-black text-xs rounded-xl border border-gray-300 transition duration-200 flex items-center gap-2 cursor-pointer shadow-sm"
                        >
                          <List className="w-4 h-4" />
...
<div key="filter-popover-1784704070975-4">
                                <div 
                        ...
                        <tr>
                          <td colSpan={7} className="p-0 bg-slate-50 border-t border-b border-gray-200 text-right font-sans">
                            ...
                            >
                              ...
                              <div className={`flex flex-col md:flex-row gap-2.5 sm:gap-3 md:gap-4 sm:p-6 relative ${!canUserEditCommittee(evt.committeeName) ? "opacity-80 pointer-events-none grayscale-[10%]" : ""}`}>
...
وتفضلوا بقبول وافر التحية والتقدير،،،`;
                                              ...
                                              <div 
                                                className="border-2 border-dashed border-gray-200 rounded-xl sm:rounded-2xl p-3.5 text-center transition-all relative bg-gray-50/50 hover:bg-gray-100/70 font-sans"
...
<div key="filter-popover-1784704070975-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 sm:gap-3 md:gap-5 text-right mb-6" dir="rtl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 sm:gap-3 md:gap-5 text-right" dir="rtl">
...
<div key="filter-popover-fixed" className="contents">
                          ...
                          <div className="space-y-1">
                            ...
                            >
                              ...
                              <GooglePickerButton
                                viewId="DOCS"
                                label="لصق أو اختيار مرفق درايف"
                                onPick={(url, name) => {
                                  setNewRecAttachments([
                                    ...newRecAttachments,
                                    { name, url, date: new Date().toISOString().substring(0, 10) }
                                  ]);
                                }}
                                className="mt-2.5 px-3 py-1 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg text-[9px] font-black w-auto justify-center"
                              />
                            </div>
                      ...
                      {newType === "متسلسلة" && (
                        <div className="md:col-span-full">
                           <div className="bg-gray-50 p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl border border-gray-200">
                             <div className="flex gap-2.5 sm:gap-3 md:gap-4 items-end">
                               <div className="flex-1 space-y-1">
                                 ...
                                 <select
                                   ...
                                   className="w-full bg-white border border-gray-300 rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-sm font-semibold focus:ring-2 focus:ring-brand focus:border-brand"
                                 >
                                     ...
                                     {importSearchResults.map((rec, idx) => {
                                       ...
                                       return (
                                         <div 
                                           ...
                                           className={`p-4 rounded-xl border-2 transition-all flex items-start gap-2.5 sm:gap-3 md:gap-4 ${rec.isAdded ? 'border-gray-200 bg-gray-100 opacity-60 cursor-not-allowed' : isSelected ? 'border-blue-500 bg-blue-50 cursor-pointer' : 'border-gray-200 bg-white cursor-pointer hover:border-blue-300'}`}
                                         >
                                           ...
                                           <div className="flex-1 space-y-1">
                                             ...
                                             <div className="flex items-center gap-2.5 sm:gap-3 md:gap-4 mt-2">
                ...
                <div className="mt-8 pt-5 border-t border-gray-100 flex items-center justify-end flex-row-reverse gap-3">
                  {newType === "متسلسلة" ? (
                    <button
                      ...
                      className="px-3 sm:px-4 md:px-6 py-2.5 bg-brand text-white rounded-xl font-bold text-sm hover:bg-brand/90 transition-colors shadow-lg shadow-brand/20 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
      ...
      {alertState.isOpen && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/40 backdrop-blur-sm" dir="rtl">
          <div className="bg-white p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl shadow-xl w-[350px] max-w-[90vw] font-sans border border-gray-100 text-center">
            ...
            <button 
              ...
              className="px-3 sm:px-4 md:px-6 py-2 bg-brand hover:bg-brand/90 text-white text-xs font-bold rounded-lg transition-colors shadow-sm w-full"
            >
              حسناً
            </button>
          </div>
