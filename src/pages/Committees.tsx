...
const INITIAL_COMMITTEES: Committee[] = [
  {
    ...
    president: "وائل حسن عبدالعزيز طيب",
    membersCount: 13,
    specialist: "هشام عريف",
    meetingsCount: 6,
    ...
    strategicPlan: "",
    active: true,
    desc: "التنسيق الإعلامي وتطوير الهوية البصرية والتسويقية لمشاريع ومنتجات قطاعات الأعمال المختلفة بمكة المكرمة.",
    formationLetter: "قرار_تشكيل_الإعلام_والتسويق.pdf"
  },
  {
    id: 2,
    name: "التجارية",
    president: "عبدالغني بن بكر الصائغ",
    membersCount: 10,
    specialist: "عمار العمودي",
    meetingsCount: 3,
    ...
    strategicPlan: "",
    active: true,
    desc: "رعاية المصالح التجارية لمنتسبي الغرفة ومتابعة مستجدات الأسواق المحلية وتطوير سلاسل الإمداد والتجزئة.",
    formationLetter: "قرار_تشكيل_اللجنة_التجارية.pdf"
  },
  {
    id: 3,
    name: "التطوير العقاري",
    president: "هتان محمد طاسجي",
    membersCount: 18,
    specialist: "عبدالعزيز ناجي",
    meetingsCount: 7,
    recommendationsCount: 30,
    eventsCount: 0,
    ratingIssues: "",
    strategicPlan: "تم الاعتماد",
    active: true,
    desc: "تحفيز وتطوير السوق العقاري والتشجيع على الاستثمار السكني والتجاري واللوجستي في العاصمة المقدسة.",
    formationLetter: "قرار_تشكيل_التطوير_العقاري.pdf"
  },
  {
    id: 4,
    name: "التعليم الأهلي والتدريب",
    president: "عبدالله دوس عبدالله الشمراني",
    membersCount: 16,
    specialist: "موفق سندي",
    meetingsCount: 2,
    ...
    strategicPlan: "",
    active: true,
    desc: "دعم الشراكة بين القطاعين الحكومي والخاص لتطوير منظومة التعليم العام والأكاديمي والتدريب المهني.",
    formationLetter: "قرار_تشكيل_التعليم_الأهلي.pdf"
  },
  {
    id: 5,
    name: "التغذية والإعاشة",
    president: "ماجد عبدالعزيز احمد دانش",
    membersCount: 18,
    specialist: "موفق سندي",
    meetingsCount: 1,
    ...
    strategicPlan: "",
    active: true,
    desc: "تنظيم وتطوير وتأهيل منشآت تقديم خدمات التغذية والإعاشة للزوار والحجاج والمعتمرين بأعلى درجات الجودة والامتثال.",
    formationLetter: "قرار_تشكيل_التغذية_والإعاشة.pdf"
  },
  {
    id: 6,
    name: "الحج والعمرة",
    president: "مروان بن عباس شعبان",
    membersCount: 18,
    specialist: "باسم شهاب الدين",
    meetingsCount: 2,
    ...
    strategicPlan: "",
    active: true,
    desc: "الارتقاء بمستوى الخدمات المقدمة لضيوف الرحمن بالتعاون مع الجهات المعنية ونشر أفضل ممارسات الضيافة والإثراء الروحاني.",
    formationLetter: "قرار_تشكيل_الحج_والعمرة.pdf"
  },
  {
    id: 7,
    name: "الخدمات اللوجستية",
    president: "احمد بن علي صالح القحطاني",
    membersCount: 11,
    specialist: "يعقوب الريمي",
    meetingsCount: 6,
    recommendationsCount: 21,
    eventsCount: 0,
    ratingIssues: "",
    strategicPlan: "تم الاعتماد",
    active: true,
    desc: "تنمية وتجويد أعمال النقل والشحن والتخزين وسلاسل الإمداد لتمكين مكة المكرمة كمركز لوجستي محوري.",
    formationLetter: "قرار_تشكيل_الخدمات_اللوجستية.pdf"
  },
  {
    id: 8,
    name: "الصحية والدوائية",
    president: "محمد بن وهيب باحكيم",
    membersCount: 14,
    specialist: "علاء الأهدل",
    meetingsCount: 7,
    ...
    strategicPlan: "تم الاعتماد",
    active: true,
    desc: "دعم الاستثمار الطبي والصيدلاني بالقطاع الخاص وتيسير تبادل الممارسات المهنية لرفع الجودة الصحية بمكة المكرمة.",
    formationLetter: "قرار_تشكيل_الصحية_والدوائية.pdf"
  },
  {
    id: 9,
    name: "الصناعية",
    president: "نائف بن مشعل الزايدي",
    membersCount: 13,
    specialist: "باسم شهاب الدين",
    meetingsCount: 2,
    recommendationsCount: 6,
    ...
    strategicPlan: "",
    active: true,
    desc: "تحفيز الصناعة الوطنية بمكة المكرمة وتمكين تبني تقنيات الثورة الصناعية الرابعة ودعم نمو المصانع المحلية.",
    formationLetter: "قرار_تشكيل_اللجنة_الصناعية.pdf"
  },
  {
    id: 10,
    name: "الفنادق والسياحة",
    president: "عبدالمحسن عبدالرحمن العجلان",
    membersCount: 19,
    specialist: "عبدالعزيز ناجي",
    meetingsCount: 9,
    ...
    strategicPlan: "",
    active: true,
    desc: "تنمية الطاقات الاستيعابية للفنادق ودور الإيواء السياحي والتكامل مع الهيئات المعنية لتعزيز الجذب السياحي والتاريخي.",
    formationLetter: "قرار_تشكيل_الفنادق_والسياحة.pdf"
  },
  {
    id: 11,
    name: "المسؤولية الاجتماعية والتطوع",
    president: "أيمن بن عبد المنعم بانه",
    membersCount: 14,
    specialist: "يعقوب الريمي",
    meetingsCount: 11,
    recommendationsCount: 46,
    eventsCount: 1,
    ratingIssues: "",
    strategicPlan: "تم الاعتماد",
    active: true,
    desc: "تعزيز جهود المسؤولية الاجتماعية للشركات ودعم المبادرات والفرق التطوعية وإطلاق برامج مستدامة ومثمرة للمجتمع المكي.",
    formationLetter: "قرار_تشكيل_المسؤولية_الاجتماعية.pdf"
  },
  {
    id: 12,
    name: "المعارض والفعاليات",
    president: "خالد احمد عبدالله الشريف",
    membersCount: 12,
    specialist: "هشام عريف",
    meetingsCount: 5,
    recommendationsCount: 18,
    ...
    strategicPlan: "",
    active: true,
    desc: "تنمية وتجذير صناعة المؤتمرات والمعارض والملتقيات المتخصصة بمكة لتكون منصة رائدة عالمياً ومحلياً.",
    formationLetter: "قرار_تشكيل_المعارض_والفعاليات.pdf"
  },
  {
    id: 13,
    name: "المقاولين",
    president: "خالد بن رده بن دبيس الحارثي",
    membersCount: 13,
    specialist: "عمار العمودي",
    meetingsCount: 5,
    ...
    strategicPlan: "تم الاعتماد",
    active: true,
    desc: "تمكين قطاع التشييد والبناء وتذليل عقبات مشاريع المقاولات وتطوير مستندات وعقود العمل الموحدة.",
    formationLetter: "قرار_تشكيل_المقاولين.pdf"
  },
  {
    id: 14,
    name: "المهن الاستشارية",
    president: "عبدالله بن جميل طلاقي",
    membersCount: 10,
    specialist: "علاء الأهدل",
    meetingsCount: 7,
    ...
    strategicPlan: "تم الاعتماد",
    active: true,
    desc: "تأهيل بيوت الخبرة وتوطيد الممارسات الاستشارية القانونية، الهندسية، الإدارية، والمالية في مجتمع الأعمال.",
    formationLetter: "قرار_تشكيل_المهن_الاستشارية.pdf"
  },
  {
    id: 15,
    name: "تقنية المعلومات والاتصالات",
    president: "زيد بن هشام بن عبدالعزيز السيد",
    membersCount: 8,
    specialist: "عماد جمال",
    meetingsCount: 4,
    recommendationsCount: 6,
    eventsCount: 0,
    ratingIssues: "",
    strategicPlan: "",
    active: true,
    desc: "تسريع التحول الرقمي ودعم المنصات التقنية المحترفة وتحفيز تبني الذكاء الاصطناعي وبنيات الحوسبة المتقدمة.",
    formationLetter: "قرار_تشكيل_تقنية_المعلومات.pdf"
  },
  {
    id: 16,
    name: "ريادة الأعمال",
    president: "طارق بن جمال حريري",
    membersCount: 20,
    specialist: "عماد جمال",
    meetingsCount: 7,
    ...
    strategicPlan: "",
    active: true,
    desc: "دعم المبتكرين والمستثمرين الجدد وتمكين تأسيس الشركات الناشئة الواعدة بروابط تمويل ميسرة.",
    formationLetter: "قرار_تشكيل_ريادة_الأعمال.pdf"
  },
  {
    id: 17,
    name: "الأزياء",
    ...
    strategicPlan: "",
    active: false,
    desc: "تطوير ودعم قطاع الأزياء والتصميم المحلي والنهوض بالمهنيين المصممين وربطهم بسلاسل وتجارب تجارية ناجحة.",
    formationLetter: "غير مرفق.pdf"
  },
  {
    id: 18,
    name: "الأوقاف",
    ...
    strategicPlan: "",
    active: false,
    desc: "العناية بالأصول الوقفية وتنمية الموارد والمستندات القانونية والاستثمارية لتعميق الأثر التنموي والخيري لمكة المكرمة.",
    formationLetter: "غير مرفق.pdf"
  },
  {
    id: 19,
    ...
    strategicPlan: "",
    active: false,
    desc: "تنظيم وتطوير ممارسات استقدام الموارد البشرية وتسهيل قطاع التوظيف والعمالة المهنية لخدمة احتياجات أصحاب الأعمال.",
    formationLetter: "غير مرفق.pdf"
  },
  {
    id: 20,
    name: "المصاعد والسلامة",
    president: "",
    membersCount: 0,
    specialist: "علاء الأهدل",
    meetingsCount: 0,
    ...
    strategicPlan: "",
    active: false,
    desc: "تعزيز معايير السلامة والأمان الفنية لقطاع المصاعد والأنظمة الميكانيكية بالمنشآت العامة والتجارية والامتثال للمواصفات.",
    formationLetter: "غير مرفق.pdf"
  },
  {
    id: 21,
    name: "المعادن الثمينة والأحجار الكريمة",
    president: "",
    membersCount: 2,
    specialist: "هشام عريف",
    meetingsCount: 0,
    ...
    strategicPlan: "",
    active: false,
    desc: "تطوير جودة وصناعة تجارة الذهب والمجوهرات والمعادن الثمينة والأحجار الكريمة بمكة المكرمة وتعميق ثقة المستهلكين فيها.",
    formationLetter: "غير مرفق.pdf"
  },
  {
    id: 22,
    name: "مراكز التجميل والصوالين النسائية",
    president: "",
    membersCount: 1,
    specialist: "علاء الأهدل",
    meetingsCount: 0,
    ...
    strategicPlan: "",
    active: false,
    desc: "تنظيم وتطوير قطاع خدمات التجميل والصوالين النسائية والنهوض بالمهارات والامتثال للاشتراطات الصحية والبلدية.",
    formationLetter: "غير مرفق.pdf"
  }
];
...
export default function Committees() {
  ...
  const EXPORT_FIELDS_META = [
    ...
    { key: "membersCount", label: "عدد الأعضاء الفعليين" },
  ...
  const handleExportToGoogleSheets = () => {
    ...
    try {
      ...
      let activeUser = "باسم شهاب الدين";
      if (stored) {
        try {
