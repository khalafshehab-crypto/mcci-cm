              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2 pt-2 border-t border-gray-200/60">
                    ...
                    >
                      ...
                      <Download className="w-3.5 h-3.5" />
                          ...
                          <button
                            ...
                            className="p-1.5 text-blue-600 hover:text-white hover:bg-blue-600 rounded-lg transition-colors border border-blue-600/20 shadow-sm hover:shadow"
                    ...
                    <button
                      onClick={() => handleOpenAI(t)}
                      className="flex items-center justify-center gap-1.5 px-3 py-2 bg-gradient-to-l from-blue-600 to-blue-500 text-white hover:brightness-110 rounded-lg text-xs font-extrabold transition-all shadow-sm"
