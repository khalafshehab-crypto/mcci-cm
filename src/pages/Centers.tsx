    ...
    <div className="space-y-6" dir="rtl">
      ...
      >
        <div className="text-gray-400 mb-4 flex justify-center">
          <Building2 className="w-10 h-10 sm:w-12 sm:h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 opacity-20" />
        </div>
        <h2 className="text-sm sm:text-base md:text-lg font-bold text-gray-800 mb-2">مساحة عمل جديدة</h2>
        <p className="text-sm text-gray-500 max-w-md mx-auto leading-relaxed">
          تم إنشاء هذه الصفحة المستقلة لتكون خاصة بإدارة المراكز. يمكنك الآن تزويدي بالمتطلبات والميزات والشاشات التي تريد إضافتها هنا.
        </p>
      </motion.div>
    </div>
  );
