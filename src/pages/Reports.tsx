                  ...
                  <table className="w-full text-right border-collapse">
                    <thead className="bg-[#dfdada] text-gray-700 font-extrabold text-sm border-b border-gray-300">
                      <tr>
                        ...
                        <th className="py-4 px-5 whitespace-nowrap">الدورية</th>
                        <th className="py-4 px-5 whitespace-nowrap">النوع</th>
                        <th className="py-4 px-5 whitespace-nowrap">بواسطة</th>
                        <th className="py-4 px-5 whitespace-nowrap">الحالة</th>
                        <th className="py-4 px-5 whitespace-nowrap">تواريخ التقرير</th>
                    ...
                    <tbody className="divide-y divide-gray-200/60">
                      {reports.map((report) => (
                        <tr key={report.id} className="hover:bg-white/40 transition-colors text-sm font-semibold text-gray-800">
                          ...
                          <td className="py-4 px-5 text-gray-600">{report.periodType}</td>
              ...
              <div className="box-border border border-gray-200 rounded-2xl overflow-hidden bg-[#e8e4e4] shadow-sm">
                <div className="overflow-x-auto">
                  <table className="w-full text-right border-collapse">
                    <thead className="bg-[#dfdada] text-gray-700 font-extrabold text-sm border-b border-gray-300">
                      <tr>
                        <th className="py-4 px-5 whitespace-nowrap">المؤشر</th>
                        <th className="py-4 px-5 whitespace-nowrap">المعيار</th>
                        <th className="py-4 px-5 whitespace-nowrap">الفترة</th>
                        <th className="py-4 px-5 whitespace-nowrap">التواريخ</th>
                        <th className="py-4 px-5 whitespace-nowrap">المستهدف</th>
                        <th className="py-4 px-5 whitespace-nowrap">المحقق</th>
                        <th className="py-4 px-5 text-center whitespace-nowrap">إجراءات</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200/60">
                      {kpis.map((kpi) => (
                        <tr key={kpi.id} className="hover:bg-white/40 transition-colors text-sm font-semibold text-gray-800">
                          <td className="py-4 px-5 font-bold">{kpi.indicator}</td>
                          <td className="py-4 px-5 text-gray-600">{kpi.standard}</td>
                          <td className="py-4 px-5">
                          ...
                          <td className="py-4 px-5 font-black text-gray-500">{kpi.targetValue}</td>
                          <td className="py-4 px-5 font-black text-emerald-600">{kpi.achievedValue}</td>
                          <td className="py-4 px-5">
                            <div className="flex items-center justify-center gap-2">
