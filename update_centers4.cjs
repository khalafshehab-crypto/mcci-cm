...
const singleInsertPoint = code.indexOf('<div className="space-y-1 md:col-span-3">');
...
if (singleInsertPoint > -1 && code.indexOf('دعوة موظفين آخرين للاجتماع') === -1) {
    code = code.slice(0, singleInsertPoint) + singleInviteesInsert + "\\n" + code.slice(singleInsertPoint);
}
