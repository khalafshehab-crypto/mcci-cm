const fs = require('fs');
let content = fs.readFileSync('src/pages/Recommendations.tsx', 'utf8');
...
fs.writeFileSync('src/pages/Recommendations.tsx', content);
console.log("Patched Recommendations.tsx page");
